...
assert.match(chromePopup, /storageGetArea\("local", \{ nrExcludedSites: \[\], nrSiteColors: \{\} \}/);
assert.match(chromePopup, /storageSetArea\("local", \{ nrExcludedSites: excludedSites, nrSiteColors: siteColors \}\)/);
assert.match(chromePopup, /nr-site-color/);
assert.match(chromePopup, /nrSiteColors/);
assert.match(chromePopup, /currentTabSite/);
assert.match(firefoxPopup, /storageGetArea\("local", \{ nrExcludedSites: \[\], nrSiteColors: \{\} \}/);
assert.match(firefoxPopup, /storageSetArea\("local", \{ nrExcludedSites: excludedSites, nrSiteColors: siteColors \}\)/);
